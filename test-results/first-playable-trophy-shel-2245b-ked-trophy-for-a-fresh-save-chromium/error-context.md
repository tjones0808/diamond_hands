...
- Name: first-playable.spec.ts >> trophy shelf >> shows a single unlocked trophy for a fresh save
- Location: tests\first-playable.spec.ts:294:3
    ...
    - region "Room scene":
      - complementary "Trophy shelf":
        ...
        - list:
          ...
          - listitem "Locked — reach Prop Desk Rookie": "???"
          - listitem "Locked — reach Stock Broker": "???"
  ...
  - region "Trading terminal":
    - region "Trading terminal":
      - region "Market choices and log":
        - button "GLMR +0.0% $23.94":
          - text: GLMR
          - emphasis: +0.0%
          - strong: $23.94
        - button "SNAX +0.0% $30.09":
          - text: SNAX
          - emphasis: +0.0%
          - strong: $30.09
        - button "CURR +0.0% $54.88":
          - text: CURR
          - emphasis: +0.0%
          - strong: $54.88
        - button "GENE +0.0% $17.16":
          - text: GENE
          - emphasis: +0.0%
          - strong: $17.16
        - button "BRIK +0.0% $19.90":
          - text: BRIK
          - emphasis: +0.0%
          - strong: $19.90
        - button "VACC +0.0% $51.95":
          - text: VACC
          - emphasis: +0.0%
          - strong: $51.95
        - button "PLSM +0.0% $17.54":
          - text: PLSM
          - emphasis: +0.0%
          - strong: $17.54
        - button "HELI +0.0% $17.89":
          - text: HELI
          - emphasis: +0.0%
          - strong: $17.89
      ...
      - region "Trading controls":
        ...
        - article:
          ...
          - tablist "Stock intel tabs":
            ...
            - tab "Technicals"
            - tab "News"
          - tabpanel: P/E Ratio 19 EPS $1.26 Market Cap MID Beta 1 Revenue Growth +3% Dividend Yield 1.6% Signal Quality 46% Volatility 10% Short Interest 23.6% 52W High $28.88 52W Low $18.26 Analyst Target $23.80
          - img "Candlestick chart with prior history, moving average, and support/resistance": SUP $18.26 RES $28.25 THIS WK MON TUE WED THU FRI 5-bar MA
        - region "Trade ticket":
          ...
          - text: Buying Power $5,000 Est. Share Cost $239 Call $25 $2.29 / $$229 Put $23 $2.30 / $$230 DTE 5d
      ...
      - region "Positions and progress":
        ...
        - region "Weekly goals":
          ...
          - text: Cash plus marked shares $5,000 / $6,000
          - strong: Build street rep to 42
          - text: Protect the week and win cleanly 40 / 42
...
```ts
  ...
  202 | 
  203 |     return {
  204 |       hasHorizontalScroll: document.documentElement.scrollWidth > document.documentElement.clientWidth,
  205 |       hasVerticalScroll: document.documentElement.scrollHeight > document.documentElement.clientHeight,
  206 |       commandDeck,
  207 |       room,
  208 |       statusDeck,
  209 |       hud,
